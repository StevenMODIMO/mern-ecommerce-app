...
export default function Signup() {
  ...
  return (
    <div className="shadow-xl rounded-sm border-t-2 border-black py-2 px-4 sm:w-96 mx-auto mt-10">
      <Alert />
      ...
      >
        ...
        />
        {loading ? <Loader /> : <button disabled={loading} className="p-1 rounded-sm bg-yellow-500">
          Sign Up
        </button>}
        {
