...
const { getAllProducts, registerSeller, registerBuyer, newProduct, getProducts, getProductById, deleteProducts, getOrders, getSingleProduct, addToCart, getCartProducts, getCartProduct, removeFromCart, addWishList, getWishlistProducts, getSingleWishListProduct, removeWishList, intitiatePayment, generateBuyerInvoice, generateSellerInvoice, shipProduct } = require("../controllers/appControllers");
