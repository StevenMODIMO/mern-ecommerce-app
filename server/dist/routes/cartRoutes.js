 ...
 */
router.put("/update-cart/:product_id", express_1.default.json(), cartControllers_1.updateCart);
/**
 * @swagger
 ...
 */
router.delete("/remove-item/:product_id", cartControllers_1.removeItemFromCart);
